...
import { removeRecipeFromFamily } from "@/app/dashboard/families/actions";
...
export function RemoveRecipeFromFamilyButton({ familyId, recipeId }: Props) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            This will remove the recipe from this family. The recipe itself will
            not be deleted.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
